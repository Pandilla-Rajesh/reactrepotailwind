...
const Aboutus = () => {
  ...
  const alertName = () => { alert('Hi Arjun') }
      ...
      <Row>
        <Col lg={ 4 }>
          <Card>
            ...
            <Card.Body>
              <ModalReUse show={ show }
                title="book" className="bg-green-500"
                footer={ <Button onClick={ () => setShow(false) } variant='secondary'>Close</Button> }
              >
                <p className='text-sm text-slate-800'>This dynamic custom modal
                  popup about us component</p>
              </ModalReUse>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col className='d-flex justify-content-end align-items-center'>
          ...
          <div className='app'>
            <button onClick={ (decrementCount) } className='btn btn-dark text-white me-3'>
              Click Here Two</button>
            { count }
          </div>
        </Col>
